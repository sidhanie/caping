...
class Main:
	def __init__(self):
		...
		'Accept-Language':'in',
		'NETWORKSTATE':'FouthG',
		'User-Agent':'Mozilla/5.0 (Linux; Android 7.1.2; Redmi Note 5A Build/N2G47H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36;CapingNews/5.3.4,
